  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-12 w-full max-w-xl">
        ...
        {/* Pattern Display */}
        <div className="flex gap-2 p-6 bg-muted rounded-3xl border-4 border-border justify-center items-center flex-wrap">
          {sequence.map((item, i) => (
            <div 
              key={i} 
          ...
          <div className="h-20 w-20 flex items-center justify-center text-4xl font-bold border-4 border-dashed border-border rounded-2xl bg-card">
            {selected || "?"}
          </div>
        </div>
