...
export type MiddleModuleId = "pet-robot" | "ice-cream" | "treehouse" | "water-park";
export type TeenModuleId = "dream-room" | "escape-room" | "food-truck" | "theme-park";
export type ModuleId = EarlyModuleId | ElementaryModuleId | MiddleModuleId | TeenModuleId;
...
export const MIDDLE_MODULES: MiddleModuleId[] = ["pet-robot", "ice-cream", "treehouse", "water-park"];
export const TEEN_MODULES: TeenModuleId[] = ["dream-room", "escape-room", "food-truck", "theme-park"];
