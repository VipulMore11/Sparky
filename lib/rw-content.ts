import type { AgeContent, AgeGroup } from "./rw-types"

// ---------------------------------------------------------------------------
// EARLY (3-5) — Explorer Island: letters, words, simple instructions, light STEM
// ---------------------------------------------------------------------------
const earlyContent: AgeContent = {
  age: "early",
  label: "Ages 3–5",
...
// ---------------------------------------------------------------------------
// ELEMENTARY (6-8) — Word Valley: short passages, instructions, simple responses
// ---------------------------------------------------------------------------
const elementaryContent: AgeContent = {
  age: "elementary",
  label: "Ages 6–8",
...
// ---------------------------------------------------------------------------
// MIDDLE (9-12) — Logic Mountain: analytical reading, explanation writing
// ---------------------------------------------------------------------------
const middleContent: AgeContent = {
  age: "middle",
  label: "Ages 9–12",
...
// ---------------------------------------------------------------------------
// TEEN (13-18) — Discovery Lab: academic reading, scientific writing
// ---------------------------------------------------------------------------
const teenContent: AgeContent = {
  age: "teen",
  label: "Ages 13–18",
